...
const STATUS_COLORS = {
	...
	not_registered: "bg-gray-50 text-gray-400 border border-dashed border-gray-300",
};
...
export default function Translations() {
	...
	const getStatusBadge = (item, langCode) => {
		...
		if (!translation) {
			return (
				<span className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${STATUS_COLORS.not_registered}`}>
					not registered
				</span>
			);
		}
						...
						<div className="space-y-4">
							<div>
								...
								<input
									...
									onChange={(e) =>
										setTranslationFields({ ...translationFields, title: e.target.value })
									}
							...
							<div>
								...
								<textarea
									...
									onChange={(e) =>
										setTranslationFields({ ...translationFields, content: e.target.value })
									}
									rows={6}
									className="w-full rounded-md border border-gray-300 px-3 py-2"
								/>
							...
							<div>
								...
								<textarea
									...
									onChange={(e) =>
										setTranslationFields({ ...translationFields, excerpt: e.target.value })
									}
									rows={3}
									className="w-full rounded-md border border-gray-300 px-3 py-2"
								/>
