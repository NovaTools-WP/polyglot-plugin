...
const URL_STRATEGIES = [
  {
    value: "directory",
    label: "Directory",
    description: "example.com/en/page",
  },
  {
    value: "subdomain",
    label: "Subdomain",
    description: "en.example.com/page",
  },
  { value: "domain", label: "Domain", description: "example.fr/page" },
  {
    value: "query_param",
    label: "Query Parameter",
    description: "example.com/page?lang=en",
  },
];

const WOO_CURRENCIES = [
  "USD",
  "EUR",
  "GBP",
  "JPY",
...
export default function Settings() {
  const [settings, setSettings] = useState({
    ...
    woocommerce: {
      multi_currency: { enabled: false, mode: "by_language", rates: {} },
    },
  });
            ...
            <label className="flex items-center gap-2">
              <input
                ...
                onChange={(e) =>
                  setSettings({
                    ...settings,
                    browser_redirect: e.target.checked,
                  })
                }
                className="rounded"
              />
      ...
      {activeTab === "post_types" && (
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              {["category", "post_tag", "product_cat", "product_tag"].map(
                (tax) => (
      ...
      {activeTab === "custom_fields" && (
        <div className="space-y-4">
          <p className="text-sm text-gray-600">
            Custom field translation is handled automatically based on your post
            type selections.
          </p>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...
                      media: {
                        ...settings.media,
                        translate_alt_text: e.target.checked,
                      },
                    })
                  }
                  className="rounded"
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...
                      media: {
                        ...settings.media,
                        translate_captions: e.target.checked,
                      },
                    })
                  }
                  className="rounded"
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...
                      media: {
                        ...settings.media,
                        translate_descriptions: e.target.checked,
                      },
                    })
                  }
                  className="rounded"
      ...
      {activeTab === "scanning" && (
        <div className="space-y-6">
          <div>
            ...
            <p className="mb-4 text-sm text-gray-500">
              Automatically scan and register translatable strings when a plugin
              or theme is activated.
            </p>
            <label className="flex items-center gap-2">
              <input
                type="checkbox"
              ...
              />
              <span className="text-sm text-gray-700">
                Enable auto-scan on plugin/theme activation
              </span>
            </label>
          </div>
        </div>
            ...
            <>
              ...
              {settings.woocommerce.multi_currency.mode === "manual" && (
                <div>
                  ...
                  <div className="space-y-2">
                    {WOO_CURRENCIES.filter((c) => c !== "USD").map(
                      (currency) => (
