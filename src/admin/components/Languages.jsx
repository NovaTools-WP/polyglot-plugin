    ...
    <div className="p-6">
      ...
      <div className="mt-8 rounded-lg border bg-white p-6 shadow-sm">
        ...
        <p className="mb-4 text-sm text-gray-600">
          Once you have configured and activated multiple languages, you can
          display the language switcher on your site using one of the following
          methods:
        </p>
        <div className="space-y-4 text-sm text-gray-700">
          <div>
            <h3 className="font-semibold text-gray-900">
              1. Navigation Menu (Recommended)
            </h3>
            <p className="text-gray-600">
              ...
              , select the checkbox for your target languages in the "PolyGlot
              Languages" section on the left, and click "Add to Menu".
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-600">
              ...
              to any page, post, or text widget.
            </p>
            <p className="mt-1 text-xs text-gray-500">
              Supported attributes: <code className="font-mono">format</code>{" "}
              ("list" or "dropdown"),{" "}
              <code className="font-mono">show_flags</code> ("true" or "false"),{" "}
              <code className="font-mono">show_names</code> ("true" or "false"),
              and <code className="font-mono">exclude</code> (comma-separated
              codes).
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-600">
              Insert the "PolyGlot Language Switcher" block in the block editor
              (found under the Widgets category) and customize settings in the
              sidebar.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-600">
              ...
              and drag the "PolyGlot Language Switcher" widget into any widget
              area.
            </p>
          </div>
          <div>
            ...
            <p className="mb-2 text-gray-600">
              To render the switcher programmatically in your theme files (e.g.{" "}
              <code className="font-mono">header.php</code>), use this code:
            </p>
          ...
          <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
            ...
            {availableToAdd.length === 0 ? (
              <p className="mb-4 text-gray-500">
                All available languages are already active.
              </p>
            ) : (
              <>
                <input
