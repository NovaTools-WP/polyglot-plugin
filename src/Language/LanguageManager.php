	...
	public function add( array $data ): Language {
		...
		if ( $existing ) {
			...
			$update = array(
				...
				'flag_code'    => $data['flag_code'] ?? $existing['flag_code'] ?? ( FlagResolver::countryCode( $data['code'] ) ?: $data['code'] ),
			...
			$wpdb->insert( $table, array(
				...
				'flag_code'     => $data['flag_code'] ?? ( FlagResolver::countryCode( $data['code'] ) ?: $data['code'] ),
				'flag_url'      => '',
