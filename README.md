...
- _(Optional but recommended)_ WooCommerce: Required for WooCommerce translation features.
...
6.  _If NovaTools Core is not active, you will see an admin notice prompting you to install/activate it._
