...
namespace NovaTools\Polyglot\Libs\Assets;
...
function get_manifest( string $manifest_dir ): object {
	...
	/** This filter is documented in vendor/kucrut/vite-for-wp/src/enqueue.php */
 ...
 * @since 0.1.0
 *
 * @param string $manifest_dir Path to directory containing manifest file.
 * @param string $entry        Entrypoint to enqueue.
 * @param array  $options      Enqueue options.
 *
 * @return array|null
